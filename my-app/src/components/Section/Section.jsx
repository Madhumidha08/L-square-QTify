...
export default function Section({ title, type, data, filterSource }) {
    ...
    }, [filterSource, filters]); // Include filterSource and filters in the dependency array
                ...
                cardsToRender.length === 0 ? (
                    ...
                    <div className={styles.cardWrapper}>
                        {!carouselToggle ? (
                            ...
                            <Carousel data={cardsToRender} renderComponent={(data) => <Card key={data.id} data={data} type={type}/>}/>
                        )}
                    </div>
                )
            }
